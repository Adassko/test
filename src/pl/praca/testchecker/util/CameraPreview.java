package pl.praca.testchecker.util;
...
public class CameraPreview extends SurfaceView
	implements SurfaceHolder.Callback, Camera.AutoFocusMoveCallback, Camera.AutoFocusCallback {
    ...
    private boolean lockAutoFocus = true;
